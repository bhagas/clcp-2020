...
router.get('/', function(req, res) {
  connection.query("SELECT a.kecamatan, kode_k, x(centroid(a.SHAPE)) as xe, y(centroid(a.SHAPE)) as ye  from kecamatan a ", function(err, rows, fields) {
    ...
    res.render('content/struktur_ruang', {kec : rows});
  })

});

router.get('/sistem_pusat_kegiatan', function(req, res) {
  res.render('content/sistem_pusat_kegiatan');
});

router.get('/sistem_jaringan_prasarana', function(req, res) {
  res.render('content/sistem_jaringan_prasarana');
});
